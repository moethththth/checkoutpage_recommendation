...
function specialCharactersValidation(currentObj) {
  ...
  if (pattern && currentValue && validationMessage && (currentObj.hasClass('shippingFirstName') || currentObj.hasClass('billingFirstName') || currentObj.hasClass('shippingLastName') || currentObj.hasClass('billingLastName') || currentObj.hasClass('shippingAddressOne') || currentObj.hasClass('billingAddressOne') || currentObj.hasClass('shippingAddressTwo') || currentObj.hasClass('billingAddressTwo'))) {
    ...
    var nonMatchingChars = currentValue.split('').filter(function (_char) {
      return !pattern.test(_char);
    });
    nonMatchingChars = nonMatchingChars.filter(function (_char2, index) {
      return nonMatchingChars.indexOf(_char2) === index;
    });
...
module.exports = {
  ...
  focusoutValidation: function focusoutValidation() {
    $('body').on('blur', 'input, select', function (e) {
      ...
      if (currentObj.attr('id') === 'registration-form-email' || currentObj.hasClass('js-shipping-email')) {
  ...
  showPasswordConfirm: function showPasswordConfirm() {
...
module.exports = function () {
  ...
  $('body').on('cart:update', function () {
    updateMiniCart = true;
    var action = $('.cart-page-container').data('minicartflyout');
    ...
    $.ajax({
      ...
      success: function success(data) {
        $('.mini-cart-wrap').empty().html(data);
        updateMiniCart = false;
      }
    });
  });
...
var Carousel = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Carousel, [{
    ...
    value: function to(index) {
      ...
      if (this._isSliding) {
        (0, _jquery["default"])(this._element).one(Event.SLID, function () {
    ...
    value: function _addEventListeners() {
      ...
      if (this._config.keyboard) {
        (0, _jquery["default"])(this._element).on(Event.KEYDOWN, function (event) {
          return _this2._keydown(event);
        });
      }

      if (this._config.pause === 'hover') {
        (0, _jquery["default"])(this._element).on(Event.MOUSEENTER, function (event) {
    ...
    value: function _addTouchEventListeners() {
      ...
      (0, _jquery["default"])(this._element.querySelectorAll(Selector.ITEM_IMG)).on(Event.DRAG_START, function (e) {
        return e.preventDefault();
      });

      if (this._pointerEvent) {
        (0, _jquery["default"])(this._element).on(Event.POINTERDOWN, function (event) {
          return start(event);
        });
        (0, _jquery["default"])(this._element).on(Event.POINTERUP, function (event) {
          return end(event);
        });

        this._element.classList.add(ClassName.POINTER_EVENT);
      } else {
        (0, _jquery["default"])(this._element).on(Event.TOUCHSTART, function (event) {
          return start(event);
        });
        (0, _jquery["default"])(this._element).on(Event.TOUCHMOVE, function (event) {
          return move(event);
        });
        (0, _jquery["default"])(this._element).on(Event.TOUCHEND, function (event) {
          return end(event);
        });
      }
    }
    ...
    value: function _triggerSlideEvent(relatedTarget, eventDirectionName) {
      ...
      var slideEvent = _jquery["default"].Event(Event.SLIDE, {
    ...
    value: function _slide(direction, element) {
      ...
      var slidEvent = _jquery["default"].Event(Event.SLID, {
      ...
      if ((0, _jquery["default"])(this._element).hasClass(ClassName.SLIDE)) {
        ...
        (0, _jquery["default"])(activeElement).one(_util["default"].TRANSITION_END, function () {
          (0, _jquery["default"])(nextElement).removeClass("".concat(directionalClassName, " ").concat(orderClassName)).addClass(ClassName.ACTIVE);
          (0, _jquery["default"])(activeElement).removeClass("".concat(ClassName.ACTIVE, " ").concat(orderClassName, " ").concat(directionalClassName));
    ...
    value: function _jQueryInterface(config) {
      return this.each(function () {
        ...
        var _config = _objectSpread(_objectSpread({}, Default), (0, _jquery["default"])(this).data());
  ...
  (0, _createClass2["default"])(Collapse, [{
    ...
    value: function _jQueryInterface(config) {
      return this.each(function () {
        ...
        var _config = _objectSpread(_objectSpread(_objectSpread({}, Default), $this.data()), (0, _typeof2["default"])(config) === 'object' && config ? config : {});
  ...
  (0, _createClass2["default"])(Modal, [{
    ...
    value: function _jQueryInterface(config, relatedTarget) {
      return this.each(function () {
        ...
        var _config = _objectSpread(_objectSpread(_objectSpread({}, Default), (0, _jquery["default"])(this).data()), (0, _typeof2["default"])(config) === 'object' && config ? config : {});
...
(0, _jquery["default"])(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event) {
  ...
  var config = (0, _jquery["default"])(target).data(DATA_KEY) ? 'toggle' : _objectSpread(_objectSpread({}, (0, _jquery["default"])(target).data()), (0, _jquery["default"])(this).data());
...
var ScrollSpy = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(ScrollSpy, [{
    ...
    key: "_getConfig",
    value: function _getConfig(config) {
      config = _objectSpread(_objectSpread({}, Default), (0, _typeof2["default"])(config) === 'object' && config ? config : {});

window.spb = function(modules) {
    ...
    function buildPatchActions(data) {
        ...
        return {
            paymentPatch: function(patch) {
                ...
                return function(paymentID, patch, token) {
                ...
                }(paymentID, patch, data.orderID).catch(handlePatchError);
            },
            ...
            onAuthorize: function(data, actions) {
                ...
                actions = function(checkout, data, actions, overrides) {
                    ...
                    var paymentGet = memoize((function() {
                        ...
                        return (isNative || forceRestAPI) && facilitatorAccessTokenPromise ? facilitatorAccessTokenPromise.then((function(facilitatorAccessToken) {
                    ...
                    var paymentExecute = memoize((function() {
                        ...
                        return isNative && facilitatorAccessTokenPromise && !buyerAccessToken || forceRestAPI && facilitatorAccessTokenPromise && !buyerAccessToken ? facilitatorAccessTokenPromise.then((function(facilitatorAccessToken) {
                        ...
                        })) : executePayment(paymentID, payerID, token).catch(handleExecuteError).finally(paymentGet.reset);
                    }));
                    var orderGet = memoize((function() {
                        ...
                        return forceRestAPI && facilitatorAccessTokenPromise ? facilitatorAccessTokenPromise.then((function(facilitatorAccessToken) {
                    ...
                    var orderCapture = memoize((function() {
                        ...
                        })) : captureOrder(data.orderID).catch(handleExecuteError).finally(orderGet.reset);
                    }));
                    var orderAuthorize = memoize((function() {
                        ...
                        }(data.orderID).catch(handleExecuteError).finally(orderGet.reset);
                    }));
                                        ...
                                        onAuthorize: function(data, actions) {
                                            var newActions = function(checkout, data, actions) {
                                                ...
                                                var paymentExecute = memoize((function() {
                                                    ...
                                                    return executePayment(data.paymentID, data.payerID, data.orderID).catch(handleExecuteError).finally(paymentGet.reset);
                                                }));
                                                var orderGet = memoize((function() {
    ...
    function setupButton(buttonOpts) {
        if (!window.name || 0 !== window.name.indexOf("__prerender")) {
            ...
            }, _window$xprops = window.xprops, payment = _window$xprops.payment, onError = _window$xprops.onError, 
            commit = _window$xprops.commit, onClick = _window$xprops.onClick, fundingSource = _window$xprops.fundingSource, 
            _window$xprops2 = window.xprops, onAuthorize = _window$xprops2.onAuthorize, _onCancel = _window$xprops2.onCancel, 
            _onShippingChange = _window$xprops2.onShippingChange, fundingSourcesList = document.querySelectorAll("[data-funding-source]"), 
            fundingSources = [].slice.call(fundingSourcesList).map((function(el) {
                return el.getAttribute("data-funding-source");
            })).filter(Boolean), facilitatorAccessTokenPromise = (clientID = window.xprops.client && window.xprops.client[window.xprops.env]) ? createAccessToken(clientID) : window.paypal.Promise.resolve(), 
            window.exports = {
            ...
            var native = function(_ref2) {
                ...
                var storageID = window.xprops.storageID;
                            ...
                            if (native_native_isEligible({
                                ...
                                !function(_ref) {
                                    ...
                                    logger.addTrackingBuilder((function() {
                                        ...
                                        _ref3.context_id = buttonSessionID, _ref3.button_session_id = buttonSessionID, _ref3.button_version = "4.0.41", 
        ...
        var isEnabled, _window$xprops, payment, onError, commit, onClick, fundingSource, _window$xprops2, onAuthorize, _onCancel, _onShippingChange, fundingSourcesList, fundingSources, facilitatorAccessTokenPromise, clientID;
